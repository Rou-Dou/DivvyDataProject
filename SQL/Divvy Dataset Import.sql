...
GO
	...
	--create main data table from 12 months of Divvy data

CREATE TABLE Divvy.dbo.d_trips_12months(ride_id VARCHAR(50) PRIMARY KEY, rideable_type VARCHAR(50)
...
BULK INSERT Divvy.dbo.d_trips_12months
...
UPDATE Divvy.dbo.d_trips_12months
